...
$(window).on('load', function() {
	 jQuery("#wrapper").removeClass("ph-item");
});
...
//function initswipe(){if($(window).width() < 767){jQuery("#wrapper").swipe({swipeStatus:function(event,phase,direction,distance,duration,fingers){if (phase=="move" && direction =="right"){jQuery("html").addClass("nav-open");return false;}if (phase=="move" && direction =="left"){jQuery("html").removeClass("nav-open");return false;}}});}}
